...
filtered_desc_list = [desc for desc in Descriptors._descList if desc[0] in descriptor_names]
filtered_desc_names = [desc[0] for desc in filtered_desc_list]
calc = MoleculeDescriptors.MolecularDescriptorCalculator(filtered_desc_names)
...
def get_tpatf(m):
    ...
    try:
        ...
        script_path = os.path.join(model_path, "..", "..", "checkpoints/mayachemtools/bin/TopologicalPharmacophoreAtomTripletsFingerprints.pl")
        print("script_path")
